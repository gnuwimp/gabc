...
//------------------------------------------------------------------------------
class Tab1Parameters(val source: String = "", val dest: String = "", val cover: String = "", val artist: String = "", val title: String = "", val year: String = "", val comment: String = "", val genre: String = "", val encoder: Encoders = Encoders.MP3_CBR_128, val gap: String = "", val mono: Boolean = false) {
